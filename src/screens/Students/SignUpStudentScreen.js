...
export default class SignUpStudentScreen extends React.Component {
  // Constructor method
  constructor(props) {
    super(props);
    this.state = {
    ...
    return (
      <View style={{flex: 1, backgroundColor: color.white}}>
        ...
        <Image
          ...
          resizeMode="stretch"
        />
        <Text style={style.lblSlogan}>A room without books is like a body without a soul.</Text>
        <ScrollView>
          <View style={{
          ...
          <View style = {style.vwLogin}>
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate('SignInStudentScreen')}>
